...
public class MainActivity extends AppCompatActivity {
    ...
    public static List<Evento> eventos = new ArrayList<Evento>(){{
        ...
        ev1.getInscritos().add(inscritos.get(0));
        ev2.getInscritos().add(inscritos.get(0));
        ev2.getInscritos().add(inscritos.get(3));
        ev3.getInscritos().add(inscritos.get(1));
        ev3.getInscritos().add(inscritos.get(2));
        ev3.getInscritos().add(inscritos.get(3));
        ev4.getInscritos().add(inscritos.get(0));
        ev4.getInscritos().add(inscritos.get(3));
        ev4.getInscritos().add(inscritos.get(4));

        inscritos.get(0).getEventos().add(ev1);
        inscritos.get(0).getEventos().add(ev4);
        inscritos.get(0).getEventos().add(ev2);
        inscritos.get(1).getEventos().add(ev3);
        inscritos.get(2).getEventos().add(ev3);
        inscritos.get(3).getEventos().add(ev4);
        inscritos.get(3).getEventos().add(ev2);
        inscritos.get(4).getEventos().add(ev4);
        inscritos.get(4).getEventos().add(ev3);
